...
const templates = [
  ...
  },
  {
    ...
    phases: [
      ...
      { order: 3, slug: "bos-department-discovery", name: "Department Discovery", sublayers: [
      ...
      { order: 4, slug: "bos-sales-dept", name: "Dept: Sales", tasks: [
      ...
      { order: 5, slug: "bos-ops-dept", name: "Dept: Operations", tasks: [
      ...
      { order: 6, slug: "bos-support-depts", name: "Dept: Finance, People, Customer Service & Other", tasks: [
      ...
      { order: 7, slug: "bos-quote-to-cash", name: "Quote-to-Cash Process Discovery", tasks: [
