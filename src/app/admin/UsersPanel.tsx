...
export default function AdminUsersPanel() {
  ...
  if (loading) {
    return <p className="text-pm-muted">Loading users...</p>;
  }

  if (error) {
    return <p className="text-pm-blocked">{error}</p>;
  }
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-xl font-bold text-pm-text">User Management</h2>
